...
// Football-themed intro animation
document.addEventListener('DOMContentLoaded', function() {
    // Create intro overlay
    const introOverlay = document.createElement('div');
    introOverlay.className = 'football-intro';
    
    // Create football element
    const football = document.createElement('div');
    football.className = 'football-intro-ball';
    
    // Create text element
    const text = document.createElement('div');
    text.className = 'football-intro-text';
    text.textContent = 'Football Enthusiast';
    
    // Add elements to overlay
    introOverlay.appendChild(football);
    ...
    setTimeout(() => {
      ...
      confetti.className = 'football-confetti';
      header.appendChild(confetti);
      
      // Create football confetti
      for (let i = 0; i < 20; i++) {
        const ball = document.createElement('div');
        ball.className = 'football-confetti-ball';
        ball.style.left = `${Math.random() * 100}%`;
        ball.style.animationDelay = `${Math.random() * 2}s`;
        confetti.appendChild(ball);
      }
